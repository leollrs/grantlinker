...
export default function Systems() {
  return (
    <section id="sistemas" className="py-16 sm:py-24 md:py-28 lg:py-40">
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6">
        <div className="grid lg:grid-cols-5 gap-10 sm:gap-16 lg:gap-20">
          <div className="lg:col-span-2">
            <h2 className="text-[32px] sm:text-[36px] md:text-[44px] font-semibold text-[#E8EEF5] tracking-tight leading-[1.1] mb-4 sm:mb-5">
              Sistemas
            </h2>
            <p className="text-[14px] sm:text-[15px] text-[#9AA6B2] leading-relaxed max-w-sm mb-6">
          ...
          <div className="lg:col-span-3 grid sm:grid-cols-2 gap-3 sm:gap-4">
            {SYSTEMS.map((system) => (
              <div
                key={system.title}
                className="p-5 sm:p-6 md:p-7 rounded-xl bg-[#151B22] border border-[#1F2630]"
              >
                <h3 className="text-[14px] sm:text-[15px] font-semibold text-[#E8EEF5] mb-2">{system.title}</h3>
                <p className="text-[13px] text-[#9AA6B2] leading-relaxed mb-4 sm:mb-5">{system.desc}</p>
