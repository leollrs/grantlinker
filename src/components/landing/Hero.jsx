...
export default function Hero() {
  return (
    // ✅ Desktop stays exactly like before (2 columns, big padding)
    // ✅ Mobile becomes a true 1-screen hero where the LEFT (text/CTAs) fills the screen
    // ✅ WorkflowVisualization is hidden on mobile and starts on the next section/scroll
    <section className="relative overflow-hidden">
      ...
      {/* MOBILE: full-screen text hero */}
      <div className="relative mx-auto max-w-[1400px] px-4 sm:px-6 lg:px-8">
        <div className="min-h-[100svh] flex items-center pt-20 pb-10 lg:min-h-0 lg:pt-48 lg:pb-32">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center w-full">
            ...
            {/* RIGHT */}
            {/* ✅ Hide on mobile so the left hero truly fills the entire first screen */}
        ...
        {/* ✅ Mobile-only: show the workflow as the NEXT section (so it doesn't steal hero space) */}
