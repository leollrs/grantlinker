...
export default function Hero() {
  ...
  return (
    <section className="pt-16">
      <div className="max-w-[1200px] mx-auto px-6 pt-24 pb-20 md:pt-36 md:pb-28">
        <p className="text-[13px] text-[#9AA6B2] tracking-widest uppercase mb-8">
          Infraestructura &middot; IA &middot; Financiamiento
        </p>

        <h1 className="text-[40px] sm:text-[56px] lg:text-[68px] font-semibold text-[#E8EEF5] leading-[1.06] tracking-tight max-w-[900px] mb-7">
        ...
        <p className="text-[17px] sm:text-[19px] text-[#9AA6B2] leading-relaxed max-w-[640px] mb-12">
        ...
        <p className="text-[13px] text-[#9AA6B2]/60">
